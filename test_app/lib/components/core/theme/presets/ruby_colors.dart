...
class FyarnColorsRuby extends FyarnColors {
  ...
  @override
  Color get primary => const Color(0xFFE11D48);
  @override
  Color get onPrimary => const Color(0xFFFFFFFF);
  @override
  Color get primaryContainer => const Color(0xFFFFF1F2);
  @override
  Color get onPrimaryContainer => const Color(0xFF9F1239);
  ...
  @override
  Color get focus => const Color(0xFFE11D48);
  @override
  Color get disabled => const Color(0xFFF4F4F5);
  @override
  Color get ring => const Color(0xFFE11D48);
  ...
  @override
  Gradient get premiumGradient => const LinearGradient(
...
class FyarnColorsRubyDark extends FyarnColors {
  ...
  Color get onPrimary => const Color(0xFFFFFFFF);
  @override
  Color get primaryContainer => const Color(0xFF4C0519);
  @override
  Color get onPrimaryContainer => const Color(0xFFFFF1F2);
