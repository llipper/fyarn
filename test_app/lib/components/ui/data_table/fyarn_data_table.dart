...
class FyarnDataTable extends StatefulWidget {
  ...
  const FyarnDataTable({super.key, required this.columns, required this.rows});
    ...
    return Container(
      ...
      child: Scrollbar(
        ...
        child: SingleChildScrollView(
          ...
          child: Theme(
            data: Theme.of(context).copyWith(dividerColor: fy.colors.border),
            child: DataTable(
              headingRowColor: WidgetStateProperty.all(
                fy.colors.muted.withOpacity(0.5),
              ),
