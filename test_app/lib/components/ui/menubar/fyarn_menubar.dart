    ...
    return InkWell(
      onTap: () {
        ...
        final RelativeRect position = RelativeRect.fromLTRB(
          buttonPosition.dx,
          buttonPosition.dy +
              button.size.height, // Starts AFTER the button height
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
          horizontal: fy.spacing.sm,
          vertical: fy.spacing.xs,
        ),
        child: Text(
          title,
...
class FyarnMenubarItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(child: Text(label, style: fy.typography.bodySmall)),
        if (shortcut != null)
          Text(
            shortcut!,
