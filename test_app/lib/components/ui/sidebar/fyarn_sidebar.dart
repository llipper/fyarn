  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(right: BorderSide(color: fy.colors.border, width: 1)),
      ),
      child: SafeArea(
        child: Column(
          ...
          children: [
            if (header != null)
              Padding(padding: EdgeInsets.all(fy.spacing.xl), child: header!),
            Expanded(
            ...
            if (footer != null)
              Padding(padding: EdgeInsets.all(fy.spacing.lg), child: footer!),
          ],
        ),
      ),
    );
