    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            if (title != null) ...[
              DefaultTextStyle(style: fy.typography.h3, child: title!),
            ...
            DefaultTextStyle(style: fy.typography.bodyMedium, child: content),
                    ...
                    .map(
                      (action) => Padding(
                        padding: EdgeInsets.only(
                          bottom: action == actions!.last ? 0 : fy.spacing.sm,
                        ),
                        child: action,
                      ),
                    )
