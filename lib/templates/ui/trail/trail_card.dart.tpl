...
import 'dart:ui';
import 'package:{{project_name}}/components/core/tokens/tokens.dart';
import 'package:{{project_name}}/components/ui/text/fyarn_text.dart';
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          if (isExpanded) ...[
            Padding(
              padding: EdgeInsets.fromLTRB(fy.spacing.lg, fy.spacing.lg, fy.spacing.lg, fy.spacing.lg),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
