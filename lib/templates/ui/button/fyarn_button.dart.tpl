...
class FyarnButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (size) {
      case FyarnButtonSize.sm:
        textStyle = fy.typography.bodySmall.copyWith(fontWeight: FontWeight.w600);
        break;
      case FyarnButtonSize.md:
        textStyle = fy.typography.bodyMedium.copyWith(fontWeight: FontWeight.w600);
        break;
      case FyarnButtonSize.lg:
        textStyle = fy.typography.bodyLarge.copyWith(fontWeight: FontWeight.bold);
        break;
    ...
    Widget content = child ?? Text(text!, style: textStyle.copyWith(color: foregroundColor));
    ...
    if (isLoading) {
      content = Row(
        ...
        children: [
          ...
          if (text != null || child != null) SizedBox(width: size == FyarnButtonSize.sm ? 6 : 10),
          Opacity(
            opacity: 0.7,
            child: content,
          ),
  ...
  ButtonStyle _getButtonStyle(BuildContext context, FyarnTokens fy, Color foregroundColor) {
