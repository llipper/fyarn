...
class FyarnMemoryCard extends StatelessWidget {
  ...
  const FyarnMemoryCard({
    ...
    this.tag = 'Memories',
    this.imageUrl = 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&q=80&w=1000',
    this.onTap,
  });
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      fy.colors.primary.withOpacity(0.25), // Dinâmico: segue o tema (Amber, Ruby, Emerald...)
                      Colors.transparent,
                    ],
                  ),
                ),
