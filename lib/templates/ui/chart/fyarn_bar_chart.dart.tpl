...
class _FyarnBarChartState extends State<FyarnBarChart> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final fy = context.fy;
    final maxVal = widget.data.isEmpty ? 1.0 : widget.data.reduce((a, b) => a > b ? a : b);
        ...
        builder: (context, child) {
          return Row(
            ...
            children: List.generate(widget.data.length, (index) {
              ...
              final formattedValue = '${widget.valuePrefix}${rawValue.toStringAsFixed(0)}${widget.valueSuffix}';
              ...
              return Expanded(
                child: Padding(
                  ...
                  child: Tooltip(
                    ...
                    textStyle: fy.typography.labelMedium.copyWith(color: fy.colors.background),
                    child: Column(
