              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: CircleAvatar(
                      radius: 80,
                      backgroundColor: fy.colors.primaryContainer.withOpacity(0.3),
                    ),
                  ),
                  Positioned(
                    bottom: 20,
                    ...
                    child: CircleAvatar(
                      radius: 60,
                      backgroundColor: fy.colors.primaryContainer.withOpacity(0.2),
                    ),
                  ),
                  Center(
                    child: Column(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 20),
                      Text('or', style: fy.typography.bodySmall.copyWith(color: fy.colors.mutedForeground)),
                      const SizedBox(height: 20),
